                ...
                <div className="content-w3ls">
                  ...
                  <span style={{fontSize: '20px'}}>Mật khẩu hiện tại
                                        ...
                                        <div className="col-md-8">
                                            <Field style={{marginBottom: "0px", fontWeight: "bold"}}
                                                   className=" agileinfo"
                                                   type={showOldPassword ? "text" : "password"} id="email"
                                                   name="oldPassword" title="Chưa nhập email"></Field>
                                            <span toggle="oldPassword"
                                                  class={showOldPassword ? "fa fa-eye-slash" : "fa fa-eye"} style={{
                                                position: "relative",
                                                top: "-25px",
                                                left: "330px",
                  ...
                  <span style={{fontSize: '20px'}}>Nhập mật khẩu mới
                                        ...
                                        <div className="col-md-8">
                                            <Field style={{fontWeight: "bold"}} className=" agileinfo"
                                        ...
                                        <span toggle="newPassword"
                                              ...
                                              style={{textAlign: "right", marginLeft: "-285px"}}
                                              onClick={toggleShowNewPassword}></span>
                                    </div>
                                    <div className="row">
                                        <div className="col-md-5" style={{
                                            marginTop: '2%',
                  ...
                  <span style={{fontSize: '20px'}}>Xác nhận mật khẩu
                                        ...
                                        <div className="col-md-8">
                                            <Field style={{fontWeight: "bold"}} className=" agileinfo"
                                                   type={showNewPassword ? "text" : "password"} name="confirmPassword"
                                                   id="password2"/>
                                            <p style={{
                                                color: "red",
                                                paddingLeft: "2rem",

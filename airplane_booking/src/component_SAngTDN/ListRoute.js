                ...
                <div id="sort">
                  ...
                  <div className="form-check">
                    ...
                    >
                            ...
                            <div>
                                ...
                                <div style={{border: "solid 1px"}}>
                                    <div style={{padding: "10px"}}>
                                        ...
                                        {departurePriceTicket == 0 ? <p></p> :
                                            <p>{dayOfWeek(departureDayOfTicket)} {formatDateToDDMMYYYY(departureDayOfTicket)} | {departureTimeDeparture.slice(0, 5)} - {departureTimeArrival.slice(0, 5)} | {departureNameRoute} | {departureTypeSeat} </p>}
                                        <p
                                            style={{
                                                background: "#f1f1f1",
                                                padding: "10px 0px",
                      ...
                      {departurePriceTicket == 0 ? <p>----------</p> :
                          <b style={{color: "rgb(85, 85, 85)"}}>{new Intl.NumberFormat("de-DE").format((departurePriceTicket * (array[5] * 1 + array[6] * 1)))} VND</b>}
                      </span>
                                        </p>
                                        <p
                                            style={{
                        ...
                        {departurePriceTicket == 0 ? <p>----------</p> :
                            <b style={{color: "rgb(85, 85, 85)"}}>{new Intl.NumberFormat("de-DE").format((departurePriceTicket * 0.6 * (array[5] * 1 + array[6] * 1)))} VND</b>}
                      </span>
                                        </p>
                                    </div>
                                    <hr style={{margin: "0px"}}/>
                                    {info.loaiVe != 0 && (
                                        <div style={{padding: "10px"}}>
                                            ...
                                            {arrivalPriceTicket == 0 ? <p></p> :
                                                <p>{dayOfWeek(arrivalDayOfTicket)} {formatDateToDDMMYYYY(arrivalDayOfTicket)} | {arrivalTimeDeparture.slice(0, 5)} - {arrivalTimeArrival.slice(0, 5)} | {arrivalNameRoute} | {arrivalTypeSeat} </p>}
                                            <p
                                                style={{
                                                    background: "#f1f1f1",
                                                    padding: "10px 0px",
                                            ...
                                            >
                                                ...
                                                <span style={{float: "right"}}>
                      {arrivalPriceTicket == 0 ? <p>----------</p> :
                          <b style={{color: "rgb(85, 85, 85)"}}>{new Intl.NumberFormat("de-DE").format((arrivalPriceTicket * (array[5] * 1 + array[6] * 1)))} VND</b>}
                      </span>
                                            </p>
                                            <p
                                                style={{
                        ...
                        {arrivalPriceTicket == 0 ? <p>----------</p> :
                            <b style={{color: "rgb(85, 85, 85)"}}>{new Intl.NumberFormat("de-DE").format((arrivalPriceTicket * 0.6 * (array[5] * 1 + array[6] * 1)))} VND</b>}
                      </span>
                                            </p>
                                        </div>
                            ...
                            <div>
                                <p style={{margin: "10px", fontSize: "1.1rem"}}>
                                    <b>
                                        TỔNG TIỀN{" "}
                                        <span
                                            style={{float: "right"}}>{new Intl.NumberFormat("de-DE").format((totalPrice))} VND</span>
                                    </b>
                                </p>
                            </div>
                                ...
                                <>
                                    <button
                                        ...
                                        style={flag === true ? {
                                            ...
                                            color: "white",
                                            marginRight: "10px"
                                        } : {background: "rgb(6, 133, 170)", color: "white", marginRight: "10px"}}
                                    ...
                                    >
                                        ...
                                        {" "}
                                                                ...
                                                                <td>
                                                                    ...
                                                                    {((array[5] * 1 + array[6] * 1) > f.seatsBussinessRemaining) ?
                                                                        <img width="150px"
                                                                             src="https://saoviettravel.com.vn/images/icon-hetcho.svg"/> :
                                                                        <div>
                                                                            <h3>
                                                                            ...
                                                                            <div className="row">
                                                                                <div className="col-6">
                                                                                    <label>Đặt vé &nbsp;</label>
                                                                                    <input type="radio"
                                                                                           checked={(selecTicketDeparture === f.idRoute + "-a") || (selecTicketArrival === f.idRoute + "-a")}
                                                                                           value={f.idRoute + "-a"}
                                                                                           onChange={(e) => handleOnChangeBuyTicket(e, f.priceRoute * f.priceExtraBussiness, f.timeDeparture, f.timeArrival, f.nameRoute, "Bussiness")}
                                                                                           name="ticket"/>
                                                                                </div>
                                                                                <div
                                                                                    className="col-6"
                                                                ...
                                                                <td>
                                                                    {((array[5] * 1 + array[6] * 1) > f.seatsSkybossRemaining) ?
                                                                        <img width="150px"
                                                                             src="https://saoviettravel.com.vn/images/icon-hetcho.svg"/> :
                                                                        <div>
                                                                            <h3>
                                                                            ...
                                                                            <div className="row">
                                                                                <div className="col-6">
                                                                                    ...
                                                                                    <input type="radio" name="ticket"
                                                                                           checked={(selecTicketDeparture === f.idRoute + "-b") || (selecTicketArrival === f.idRoute + "-b")}
                                                                                           value={f.idRoute + "-b"}
                                                                                           onChange={(e) => handleOnChangeBuyTicket(e, f.priceRoute * f.priceExtraSkyboss, f.timeDeparture, f.timeArrival, f.nameRoute, "Skyboss")}/>
                                                                                </div>
                                                                                <div
                                                                                    className="col-6"
                                                                                    style={{padding: "0px"}}
                                                                ...
                                                                <td>
                                                                    {((array[5] * 1 + array[6] * 1) > f.seatsVeluxeRemaining) ?
                                                                        <img width="150px"
                                                                             src="https://saoviettravel.com.vn/images/icon-hetcho.svg"/> :
                                                                        <div>
                                                                            <h3>
                                                                            ...
                                                                            <div className="row">
                                                                                <div className="col-6">
                                                                                    <label>Đặt vé &nbsp;</label>
                                                                                    <input type="radio" name="ticket"
                                                                                           checked={(selecTicketDeparture === f.idRoute + "-c") || (selecTicketArrival === f.idRoute + "-c")}
                                                                                           value={f.idRoute + "-c"}
                                                                                           onChange={(e) => handleOnChangeBuyTicket(e, f.priceRoute * f.priceExtraVeluxe, f.timeDeparture, f.timeArrival, f.nameRoute, "Veluxe")}/>
                                                                                </div>
                                                                                <div
                                                                                    className="col-6"
                                                                                    style={{padding: "0px"}}
                                                                ...
                                                                <td>
                                                                    {((array[5] * 1 + array[6] * 1) > f.seatsEcoRemaining) ?
                                                                        <img width="150px"
                                                                             src="https://saoviettravel.com.vn/images/icon-hetcho.svg"/> :
                                                                        <div>
                                                                            <h3>
                                                                            ...
                                                                            <div className="row">
                                                                                <div className="col-6">
                                                                                    <label>Đặt vé &nbsp;</label>
                                                                                    <input type="radio" name="ticket"
                                                                                           checked={(selecTicketDeparture === f.idRoute + "-d") || (selecTicketArrival === f.idRoute + "-d")}
                                                                                           value={f.idRoute + "-d"}
                                                                                           onChange={(e) => handleOnChangeBuyTicket(e, f.priceRoute * f.priceExtraEco, f.timeDeparture, f.timeArrival, f.nameRoute, "Eco")}/>
                                                                                </div>
                                                                                <div
                                                                                    className="col-6"
                                                                                    style={{padding: "0px"}}

              ...
              <div>
                <div className="row">
                  ...
                  <div className="col-3">
                    ...
                    <p className="value">
                      {arr1[0]?.seat?.route?.timeDeparture}
                    </p>
                  </div>
                  <div className="col-3">
                ...
                <div className="row">
                  ...
                  <div className="col-3">
                    ...
                    <p className="value">
                      {arr1[0]?.seat?.route?.dateDeparture}
                    </p>
                  </div>
                  <div className="col-3">
                ...
                <div>
                  ...
                  <div className="row">
                    ...
                    <div className="col-3">
                      <p className="label">Giờ bay:</p>
                      <p className="value">
                        {arr2[0]?.seat?.route?.timeDeparture}
                      </p>
                    </div>
                    <div className="col-3">
                      <p className="label">Giờ đến:</p>
                      <p className="value">
                        {arr2[0]?.seat?.route?.timeArrival}
                      </p>
                    </div>
                  </div>
                  <div className="row">
                    ...
                    <div className="col-3">
                      <p className="label">Ngày đi:</p>
                      <p className="value">
                        {arr2[0]?.seat?.route?.dateDeparture}
                      </p>
                    </div>
                    <div className="col-3">
                      <p className="label">Ngày đến:</p>
                      <p className="value">
                        {arr2[0]?.seat?.route?.dateArrival}
                      </p>
                    </div>
                    <div className="col-3">
                      <p className="label">Tiền vé:</p>

...
export default function CustomerDetails() {
    ...
    return (
        <>
            {role === 'ROLE_CUSTOMER' ? (email === customer?.emailCustomer ?
                            ...
                            <div className="row">
                                ...
                                <div className="col-12 col-sm-12 col-md-8 col-lg-8">
                                    <div className="booking-form">
                                        <div>
                                            <p className="d" style={{fontWeight: "500", textAlign: "center"}}> THÔNG TIN
                                                CÁ NHÂN</p>
                                        </div>
                                        <form className="booking-form-padding">
                                            ...
                                            <div className="form-btn"
                                                ...
                                                <Link to={`/customers/update/${customer.idCustomer}`}

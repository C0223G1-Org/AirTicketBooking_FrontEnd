                            ...
                            <div className="container"
                                ...
                                <div
                                    ...
                                    <div className=" inline-flex mt-2 xs:mt-0 ">
                                        <button
                                            className={`style_button_page_next_employee   font-semibold py-2 px-4 rounded-l ${currentPage === 0 ? 'hidden' : ''}`}
                                        ...
                                        <button
                                            key={currentPage}
                                            className="font-semibold py-2 px-4  border-b rounded"
                                        ...
                                        {currentPage !== totalPages - 1 && (
                                            <button
                                                className='style_button_page_next_employee  font-semibold py-2 px-4 rounded-r'
                                                title="Trang sau"
                                        ...
                                        <div className="style_button_page_next_employee   font-semibold py-2 px-2 rounded">
                                            <input

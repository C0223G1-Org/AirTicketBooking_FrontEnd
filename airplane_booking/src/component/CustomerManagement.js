                            ...
                            <div className="modal-body" style={{ padding: 0 }}>
                                <div className="row container-fluid   ">
                                    ...
                                    <div className="wai"> <img  id="zhaopian" src={customer.imgCustomer}/></div>
                                        <div className="tai">
                                            <p><span className="biaoqing"><i class="fa-solid fa-user"></i>   Họ và tên:</span> {customer.nameCustomer} </p>
                                            <p><span className="biaoqing"><i class="fa-solid fa-calendar-days"></i> Năm sinh:</span> {moment(`${customer.dateCustomer}`).format('DD-MM-YYYY')}</p>
                                            <p><span className="biaoqing">{customer.genderCustomer?<i class="fa-solid fa-mars"></i>:<i class="fa-solid fa-venus"></i>}  Giới tính:</span> {customer.genderCustomer?<span>Nam</span>:<span>Nữ</span>}</p>
                                            <p><span className="biaoqing"><i class="fa-solid fa-earth-americas"></i>    Quốc gia:</span> <span>{customer.nationalityCustomer}</span></p>
                                            <p><span className="biaoqing"><i class="fa-solid fa-envelope"></i>  Email:</span> {customer.emailCustomer}</p>
                                            <p><span className="biaoqing"><i class="fa-solid fa-phone"></i> Số điện thoại:</span> {customer.telCustomer}</p>
                                            <p><span className="biaoqing"><i class="fa-solid fa-location-dot"></i>  Địa chỉ:</span> {customer.addressCustomer}</p>
                                            <p><span className="biaoqing"><i class="fa-solid fa-address-card"></i>   CCCD/Passport:</span> {customer.idCardCustomer}</p>
                                        </div>
                                    </div>
                                </div>

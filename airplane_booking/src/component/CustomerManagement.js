        ...
        return (
            <>
                <div className="background-customer">
                        ...
                        <div className=" mx-auto px-4 sm:px-8" id="customer">
                            <div style={{textAlign: 'center'}}>
                                ...
                                <div className="my-2 flex sm:flex-row flex-col">
                                    ...
                                    <div style={{float: 'right', paddingLeft: '150px'}}
                                         className="my-2 flex sm:flex-row flex-col col-md-9">
                                        ...
                                        <div className="row ">
                                            ...
                                            <div className="  col-md-4">
                                                <input
                                                    ...
                                                    placeholder="Tìm kiếm theo email" id="emailCustomer"
                                                    defaultValue={""}
                    ...
                    <div id="details">
                        <div className="modal fade" id="exampleModalDetail" tabIndex={-1}
                                        ...
                                        <div className="row container-fluid   ">
                                            ...
                                            <div className=" card_content ">
                                                ...
                                                <div className="tai">
                                                    ...
                                                    <p><span className="biaoqing"><i
                                                        class="fa-solid fa-earth-americas"></i>    Quốc gia:</span>
                                                    ...
                                                    <p><span className="biaoqing"><i
                                                        class="fa-solid fa-address-card"></i>   CCCD/Passport:</span> {customer.idCardCustomer}
                                                    </p>
                                                </div>
                                            </div>
                                        </div>

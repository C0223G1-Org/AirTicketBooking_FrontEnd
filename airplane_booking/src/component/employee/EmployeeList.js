    ...
    return (
        <>
            <div>
                    ...
                    <div className="container my-2 flex sm:flex-row flex-col">
                        <div className="flex col-ms col-4">
                            <div className="col-ms col">
                                <a href="#" className="btn font-semibold form_button_employee " style={{ marginLeft: '10px' }}>
                        ...
                        <div className="d-flex col-ms col-8">
                            ...
                            <div className="col-8 d-flex">
                                ...
                                <input className=" form-control me-2" type="search" placeholder="Tìm kiếm" aria-label="Search" value={name}
                            ...
                            <table className="min-w-full leading-normal">
                                <thead>
                                    <tr className="table_header_employee">
                                        <th className="col-1 px-4 border-b-2  text-left text-xs   uppercase tracking-wider">
                                            STT
                                        </th>
                                        ...
                                        <th className="col-3 py-2 border-b-2   text-left text-xs   uppercase tracking-wider">
                                            Tài khoản
                                        </th>
                                        <th className="col-2  border-b-2   text-left text-xs   uppercase tracking-wider">
                                            Số điện thoại
                                ...
                                <tbody>
                                    {employeeList.map((e, index) => (
                                        <tr key={e.idEmployee}>
                                            <td class="col-1 px-4 py-3 border-b border-gray-200 bg-white text-sm">{index + 1}</td>
                                            {/* <td class="col-2 py-3 border-b border-gray-200 bg-white text-sm">{e.idEmployee}</td> */}
                                            <td class="col-2 py-3 border-b border-gray-200 bg-white text-sm">{e.nameEmployee}</td>
                                            <td class="col-3 py-3 border-b border-gray-200 bg-white text-sm">{e.emailEmployee}</td>
                                            <td class="col-2 py-3 border-b border-gray-200 bg-white text-sm">{e.telEmployee}</td>
                                            <td className="col-2 py-3 bg-white text-sm">
                                                ...
                                                <a href="#" title="Sửa"><i className="fa-solid fa-pen-to-square icon_edit_employee" /></a>
                                                <a href="#" type="button" title="Xóa"
                                                 onClick={()=>{ handleDeleteEmployee(`${e.idEmployee}`,`${e.nameEmployee}`)}}>
                            ...
                            <div className="px-5 py-3 bg-white border-t flex flex-col xs:flex-row items-center xs:justify-between">
                                <div className="inline-flex mt-2 xs:mt-0">
                                    ...
                                    {Array.from(Array(totalPages).keys()).map((page) => (
                                        <button
                                            key={page}
                                            className={`text-sm font-semibold py-2 px-4 ${page === currentPage ? 'bg-gray-500 text-white' : 'bg-yellow-400 text-black'} rounded`}
                ...
                {/* Modal delete*/}
                {/* {showModal &&(
                <div className="modal fade" id="deleteModal" tabIndex={-1} aria-labelledby="exampleModalLabel5" aria-hidden="true">
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-header table_header_employee">
                                <h1 className="modal-title fs-5" id="exampleModalLabel5">Xóa nhân viên</h1>
                                <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" />
                            </div>
                            <div className="modal-body">
                                <p>Bạn chắn chắn muốn xóa nhân viên
                                    <span style={{ color: '#dfa512' }} id="nameDelete">{employeeID.nameEmployee}</span>
                                </p>
                                <p>Có mã nhân viên
                                    <span style={{ color: '#dfa512' }} id="emailDelete">{employeeID.idEmployee}</span>
                                    <span>không?</span>
                                </p>
                            ...
                            <div className="modal-footer">
                                <form>
                                    <div className="d-flex">
                                        ...
                                        <button type="submit" className="btn form_button_employee" onClick={confirmDeleteEmployee}>Xác Nhận</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                ...
                {/*modal detail*/}
                <div className="modal fade" id="detailModal" tabIndex={-1} aria-labelledby="exampleModalLabel5" aria-hidden="true">
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-header table_header_employee">
                                        ...
                                        <table>
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><p style={{ color: '#dfa512', paddingLeft: '10px', fontSize: '20px' }}>{employeeDetail.nameEmployee}</p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td><p>Giới tính: </p></td>
                                                    <td style={{ paddingLeft: '10px' }}><p>{employeeDetail.gender ? "Nam": "Nữ"}</p></td>
                                                </tr>
                                                <tr>
                                                    <td><p>Email: </p></td>
                                                    <td style={{ paddingLeft: '10px' }}><p>{employeeDetail.emailEmployee}</p></td>
                                                </tr>
                                                <tr>
                                                    <td><p>Ngày sinh: </p></td>
                                                    <td style={{ paddingLeft: '10px' }}><p>{employeeDetail.dateEmployee}</p></td>
                                                </tr>
                                            </tbody></table>
                                    </div>
                                </div>

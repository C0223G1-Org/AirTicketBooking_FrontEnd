...
export default function Home() {
  ...
  const handleSearchTicket = () => {
    navigate(
      `/list/${departure}, ${destination}, ${dateDeparture}, ${dateDestination}, ${ticketType}, ${adult}, ${children}`
    );
  };
      ...
      >
        ...
        <div className="carousel-inner">
          <div className="carousel-item active">
            <img
              src="https://www.vietnamairlines.com/~/media/B316FB8463454B8780F71E2E32C7359E.ashx"
          ...
          <div className="carousel-item">
            <img
              src="https://www.vietnamairlines.com/~/media/73798957242E4F2AA34B73B9DDB94896.ashx"
              className="d-block w-100"
              alt="..."
            />
          </div>
          <div className="carousel-item">
            <img
              src="https://www.vietnamairlines.com/~/media/91BAD72CDD9647179F9922F154E48C5D.ashx"
              className="d-block w-100"
              alt="..."
            />
          </div>
          ...
          <div className="row">
            <div className="col-6 row-cols-md-1 g-4 first-card">
              ...
              <div className="col img-down">
                <div className="card text-white travel">
                  <img
                    src="https://media.travel.com.vn/destination/tf_220726033156_024216.jpg"
                    className="card-img"
                    alt="..."
                  />
                  <div className="card-img-overlay">

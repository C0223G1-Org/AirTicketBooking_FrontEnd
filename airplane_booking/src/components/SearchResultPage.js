...
import {
  searchTicketByNameAndIdCardPassenger,
  searchTicketByNameAndIdCardPassengerResult,
                    ...
                    <div className="row">
                      <div className="col-4 info-fight">
                        ...
                        <p className="outstanding">
                          <span>{ticket.timeArrival}</span>{" "}
                          <span>{ticket.dateArrival}</span>{" "}
                        </p>
                      </div>
                      <div className="col-4 info-fight">
                        <p className="">{ticket.nameDestination}</p>
                        <p className="outstanding">
                          <span>{ticket.timeDeparture}</span>{" "}
                          <span>{ticket.dateDeparture}</span>{" "}
                        </p>
                      </div>
                      <div className="col-4 info-fight">
